...
func (f *fakeLLM) DeriveTopicsAndGenerateContext(_ context.Context, _ contracts.RepoAnalysisBundle, _ map[string]string, _ []model.TopicContext) ([]model.TopicContext, ai.Usage, error) {
